...
export const NavigationBar = () => {
    return (
        <div className="fixed left-4 top-32 py-11 pl-4 gap-9 shadow-lg drop-shadow-lg shadow-slate-700 bg-[#03071E] w-20 h-94 rounded-full flex flex-col items-start text-xl text-slate-200">
            ...
            <HashLink to="../components/#skills" smooth className="bg-transparent rounded-full px-3 h-12 text-white hover:text-[#FFBA08] hover:bg-[#03071E] flex items-center group">
            ...
            <HashLink to="../components/#projects" smooth className="bg-transparent rounded-full px-3 h-12 text-white hover:text-[#FFBA08] hover:bg-[#03071E] flex items-center group">
            ...
            <HashLink to="../components/#articles" smooth className="bg-transparent rounded-full px-3 h-12 text-white hover:text-[#FFBA08] hover:bg-[#03071E] flex items-center group">
            ...
            <HashLink to="../components/#contact" smooth className="bg-transparent rounded-full px-3 h-12 text-white hover:text-[#FFBA08] hover:bg-[#03071E] flex items-center group">
